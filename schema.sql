...
INSERT INTO `news` (`aid`, `pid`, `title`, `article_text`, `publish_datetime`) VALUES
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `validate_string` varchar(64) NOT NULL,
  `validated` tinyint(1) NOT NULL,
  PRIMARY KEY (`uid`),
  UNIQUE KEY `email` (`email`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=15 ;

INSERT INTO `users` (`uid`, `type`, `area`, `email`, `password`, `fname`, `sname`, `date_of_birth`, `validate_string`, `validated`) VALUES
(1, 'user', 'general', 'u1@k.com', '20a0db53bc1881a7f739cd956b740039', 'User One', '', '2011-02-14', '', 0),
(2, 'user', 'general', 'u2@k.com', '1926f73f97bf1985b2b367730cb75071', 'User Two', '', '2011-02-14', '', 0),
(3, 'user', 'general', 'u3@k.com', '2a9c9eb70d17fa6bf0e5cc1bc99a339d', 'User 3', '', '2011-02-06', '', 0),
(4, 'provider', 'science', 'p1@p.com', 'e35540f334ffc6042ccfff9579e8be20', 'Provider One', '', '2011-02-13', '', 0),
(5, 'provider', 'languages', 'p2@p.com', '5cc55c68d8817fe01b7af8aa9871f641', 'Provider Two', '', '2011-02-27', '', 0),
(6, 'user', 'general', 'u4@k.com', 'ddc6f7b6b52b7bd1f4b77e31d2ab4213', 'User Four', '', '0000-00-00', '', 0),
(7, 'user', 'general', 'john@doe.com', '6579e96f76baa00787a28653876c6127', 'John Doe', '', '0000-00-00', '', 0),
(0, 'admin', 'admin', 'admin@sc.ucc.ie', '25e4ee4e9229397b6b17776bfceaf8e7', 'admin', '', '1986-01-01', '', 0),
(13, 'user', 'general', 'kevin.kevinleo@gmail.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'Kevin', 'Leo', '1990-03-18', '', 0),
(14, 'user', 'general', 's@d.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'someonw', 'else', '0000-00-00', '', 0);
