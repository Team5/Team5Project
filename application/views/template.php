                        ...
                        <? endif; ?>
                            ...
                            <div class="column" id="header_logo">
                                <div class="column" id="header_logo_UCC">
                                    <img src="<?=base_url()?>/images/static/UCC%20logo.gif" width="200" height="75" alt="logo" />
                                </div>
                                <div class="column" id="header_logo_2011">
                                    <img src="<?=base_url()?>images/static/sc2011.jpg" width="454" height="75" alt="sc2011" />
                                </div>
                            </div>
                            <!--End Header-->
                        </div>
                    ...
                    <div class="row" id="side_info">
                        ...
                        <div class="column" id="side_info_right">
                            <? if(isset($right_side_info)): ?>
                                <? $this->load->view($right_side_info); ?>
                            <? else: ?>
                                <div class="row" id="calendar">
                                    <img src="<?=base_url()?>images/static/calendar.jpg" width="150" height="150" alt="cal" />
                                </div>
                            <? endif;?>
                        </div>
                    </div>
